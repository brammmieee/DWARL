...
class VelocityObstacleObservationWrapper(gym.ObservationWrapper):
    ...
    def __init__(self, env):
        ...
        # Precomputations
        self.precomputed = precomputations(self.params, visualize=False)
    ...
    def observation(self, obs):
        ...
        self.vel_obs, self.vel_obs_mid = compute_velocity_obstacle(self.params, self.lidar_points, self.precomputed)
        self.dyn_win = compute_dynamic_window(self.params, self.unwrapped.cur_vel)
        self.goal_vel = compute_goal_vel_obs(self.params, self.unwrapped.local_goal_pos, self.unwrapped.cur_vel)
