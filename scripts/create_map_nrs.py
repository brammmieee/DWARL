...
train_map_nr_list, test_map_nr_list = gt.sample_training_test_map_nrs(first_map_idx=0, last_map_idx=299, training_ratio=0.7)
...
train_map_nr_dict = gt.create_level_dictionary(train_map_nr_list, num_levels=5, total_maps=300)
test_map_nr_dict = gt.create_level_dictionary(test_map_nr_list, num_levels=5, total_maps=300)
...
lowest_level = 1
highest_level = 5
sampled_train_map_nr_list, sampled_test_map_nr_list = gt.sample_maps(train_map_nr_dict, test_map_nr_dict, maps_per_level, lowest_level, highest_level)
